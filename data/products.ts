export interface Product {
    ...
    imageExtension?: string; // Optional: Override image extension (default: .webp)
    imagePrefix?: string; // Optional: Override image prefix (default: "")
    frameCount?: number; // Optional: Override frame count (default: 120)
    zeroPadding?: boolean; // Optional: Pad frame number with zeros (e.g. 001)
}
...
export const products: Product[] = [
    {
        ...
        folderPath: "/images/mango-zip", // User requested path
        // Note: User provided assets in root /mango-zip. You should move them to public/images/mango/
        // and rename if necessary or use the configuration overrides below.
        themeColor: "#FFB74D",
        ...
        // Configuration for the provided assets 
        // folderPath is set above to /images/mango-zip as per user request.
        imageExtension: "jpg", 
        imagePrefix: "ezgif-frame-", 
        frameCount: 200, // Matched to actual file count found (approx 200)
        zeroPadding: true,
    },
    {
        id: "chocolate",
